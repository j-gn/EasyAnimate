...
public class EasyAnimate
{
	...
	internal void Update()
	{
		if (firstUpdate)
		{
			_lastUpdateTime = nowProvider();
			firstUpdate = false;
		}
		float deltaTime = nowProvider() - _lastUpdateTime;
	...
	public EasyAnimate(Func<float> pTimeNowProvider = null)
	{
		if (pTimeNowProvider == null)
		{
			nowProvider = defaultNowProvider;
		} else
		{
			nowProvider = pTimeNowProvider;
		}
	}
